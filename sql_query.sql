-- how to check how many databases i have?
SELECT COUNT(*)
FROM pg_database;


-- how to check how many databases i have with name?
SELECT datname
FROM pg_database
...
-- update age null value with median_age
UPDATE retail_sales
SET age = 42
WHERE age IS NULL;


-- find null value count in age column
SELECT COUNT(*) FROM retail_sales
WHERE age is NULL;


-- delete null_values from all the table
